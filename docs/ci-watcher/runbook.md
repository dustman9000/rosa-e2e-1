...
| OCM FVT HCP/Classic/GCP STG | Service Engineering QE | Triage directly, coordinate with QE IC |
...
| GAP E2E | Production Engineering | Skip if triage state already set, otherwise flag |
| ROSA CLI E2E | Service Engineering (ROSA CLI) | Skip if triage state already set, otherwise flag |
